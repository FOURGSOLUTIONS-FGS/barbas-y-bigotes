...
| 7 | **«El local»: Perfil \| Horario \| Días especiales — cierra la deuda de la tanda 1** | M | alto | 2, 3 | **0077** |
...
| 20 | Equipo: una ficha por colaborador + baja | M | medio | 2, 16 | **0078** |
...
**`0077_sedes_contacto.sql`** — antes del paso 7.
...
**`0078_bucket_barberos.sql`** — antes del paso 20.
