...
const MARCAS: Record<string, { bg: string; src: string; pad?: boolean }> = {
  nequi: { bg: "#1b0b2e", src: "/brand/pagos/nequi.svg", pad: true },
  ...
  return (
    ...
    >
      ...
      <img
        src={marca.src}
        alt=""
        width={Math.round(size * (marca.pad ? 0.66 : 0.6))}
        height={Math.round(size * (marca.pad ? 0.66 : 0.6))}
